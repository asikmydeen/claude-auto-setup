...
3. **Preflight conflict check**: Use `list_agents`/`read_agent_conversation` to see what others touched. If file overlap expected, message coordinator immediately.
...
Acknowledge this role and ask which task to implement.
