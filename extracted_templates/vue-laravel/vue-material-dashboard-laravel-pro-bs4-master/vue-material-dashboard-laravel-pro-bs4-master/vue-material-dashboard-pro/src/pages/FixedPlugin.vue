    ...
    <div class="dropdown show-dropdown" :class="{ show: isOpen }">
      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="github-buttons">
          <gh-btns-star
              slug="creativetimofficial/ct-vue-material-dashboard-laravel-pro-bs4"
              show-count
          ></gh-btns-star>
        </li>
          ...
          >
            <div class="centered-buttons">
              <network
                  ...
                  url="https://www.creative-tim.com/product/vue-material-dashboard-laravel-pro-bs4"
              >
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        documentationLink: "https://vue-material-dashboard-laravel-pro-bs4.creative-tim.com/documentation/",
        shareUrl: "https://www.creative-tim.com/product/vue-material-dashboard-laravel-pro-bs4",
        buyUrl: "",
        proUrl: "https://www.creative-tim.com/product/vue-material-dashboard-laravel-pro-bs4",
        freeUrl: "https://www.creative-tim.com/product/vue-material-dashboard-laravel-bs4",
        isOpen: false,
