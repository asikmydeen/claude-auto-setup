...
> Note: For more details about the tables and which tables you can use in your project please see the **Table** section from [vuematerial.io](https://vuematerial.io/components/table) and our live example of tables from [Vue Material Dashboard Pro Tables](https://demos.creative-tim.com/vue-material-dashboard-pro-bs4/#/table-list/regular)
