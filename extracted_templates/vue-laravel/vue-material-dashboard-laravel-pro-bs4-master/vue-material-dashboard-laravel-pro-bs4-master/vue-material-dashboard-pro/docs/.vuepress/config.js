...
module.exports = {
  ...
  title: 'Vue Material Dashboard Laravel PRO by Creative Tim & UPDIVISION',
  base: '/documentation/',
  markdown: {
  ...
  head: [
    ...
    ['link', { rel: 'canonical', href:'https://www.creative-tim.com/product/vue-material-dashboard-laravel-pro-bs4' }],
    ['meta ', { name: 'keywords', content:'creative tim, updivision, html dashboard, vue, vuejs, laravel, json:api, json, api, html css dashboard laravel, vue material dashboard laravel, vue material dashboard laravel pro, vue material dashboard, vue material dashboard pro, material vue admin, vue dashboard, vue dashboard pro, vue admin, web dashboard, bootstrap 4 dashboard laravel, bootstrap 4, css3 dashboard, bootstrap 4 admin laravel, material ui dashboard bootstrap 4 laravel, frontend, responsive bootstrap 4 dashboard, material design, material laravel bootstrap 4 dashboard' }],
    ...
    ['meta ', { itemprop: 'name', content:'Vue Material Dashboard Laravel PRO by Creative Tim & UPDIVISION' }],
    ...
    ['meta ', { itemprop: 'image', content:'https://s3.amazonaws.com/creativetim_bucket/products/730/original/opt_mdp_vuelaravel_thumbnail.jpg' }],
    ['meta ', { name: 'twitter:card', content:'product' }],
    ['meta ', { name: 'twitter:site', content:'@creativetim' }],
    ['meta ', { name: 'twitter:title', content:'Vue Material Dashboard Laravel PRO by Creative Tim & UPDIVISION' }],
    ...
    ['meta ', { name: 'twitter:image', content:'https://s3.amazonaws.com/creativetim_bucket/products/730/original/opt_mdp_vuelaravel_thumbnail.jpg' }],
    ['meta ', { name: 'twitter:data1', content:'Vue Material Dashboard Laravel PRO by Creative Tim & UPDIVISION' }],
    ['meta ', { name: 'twitter:label1', content:'Product Type' }],
    ['meta ', { name: 'twitter:label2', content:'Price' }],
    ['meta ', { property: 'fb:app_id', content:'655968634437471' }],
    ['meta ', { property: 'og:titled', content:'Vue Material Dashboard Laravel PRO by Creative Tim & UPDIVISION' }],
    ['meta ', { property: 'og:type', content:'article' }],
    ['meta ', { property: 'og:url', content:'https://www.creative-tim.com/live/vue-material-dashboard-laravel-pro' }],
    ['meta ', { property: 'og:image', content:'https://s3.amazonaws.com/creativetim_bucket/products/730/original/opt_mdp_vuelaravel_thumbnail.jpg' }],
  ...
  themeConfig: {
    ...
    repo: 'creativetimofficial/ct-vue-material-dashboard-laravel-pro-bs4',
