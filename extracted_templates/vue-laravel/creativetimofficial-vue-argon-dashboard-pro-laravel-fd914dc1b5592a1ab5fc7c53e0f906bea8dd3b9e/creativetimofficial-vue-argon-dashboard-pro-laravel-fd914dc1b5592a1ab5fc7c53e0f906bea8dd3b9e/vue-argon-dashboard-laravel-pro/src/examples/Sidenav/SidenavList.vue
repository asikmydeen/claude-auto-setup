    ...
    <ul class="navbar-nav">
        ...
        >
          ...
          <template #list>
            <ul class="nav ms-4">
              ...
              <div v-if="role == 'admin' || role == 'creator'">
                <sidenav-item
                ...
                />
                <sidenav-item
                  :to="{ name: 'Tag Management' }"
                  mini-icon="TM"
                  text="Tag Management"
                />
                <sidenav-item
                  :to="{ name: 'Item Management' }"
                  mini-icon="IM"
      ...
      <li class="nav-item">
        <sidenav-collapse
          ...
          url="#"
          :aria-controls="''"
          collapse-ref="https://github.com/creativetimofficial/ct-vue-argon-dashboard-pro-laravel/blob/main/CHANGELOG.md"
        >
          <template #icon>
            <i
        ...
        links: [
          {
            label: 'Documentation',
            route:
              'https://vue-argon-dashboard-laravel-docs.creative-tim.com/vue/overview/argon-dashboard/',
            color: 'dark',
          },
          {
            label: 'Buy now',
            route:
              'https://www.creative-tim.com/product/vue-argon-dashboard-pro-laravel?ref=vadp',
            color: 'success',
          },
        ],
      }"
