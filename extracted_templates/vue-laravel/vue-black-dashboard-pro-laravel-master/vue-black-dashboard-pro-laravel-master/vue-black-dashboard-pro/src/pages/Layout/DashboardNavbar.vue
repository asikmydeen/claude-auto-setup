<template>
  <base-nav v-model="showMenu" class="navbar-absolute top-navbar" type="white" :transparent="true">
    ...
    <div class="ml-auto">
      <a href="https://vue-black-dashboard-pro-laravel.creative-tim.com/documentation/" target="_blank" rel="noopener"
        class="btn btn-default btn-block btn-round d-lg-inline d-none">
        Documentation
      </a>
      <a href="https://www.creative-tim.com/product/vue-black-dashboard-pro-laravel" target="_blank" rel="noopener"
