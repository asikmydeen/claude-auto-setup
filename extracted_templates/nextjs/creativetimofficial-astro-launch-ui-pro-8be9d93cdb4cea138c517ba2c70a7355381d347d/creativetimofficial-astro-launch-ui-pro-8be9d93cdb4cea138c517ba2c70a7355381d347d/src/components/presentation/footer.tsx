            ...
            <div className="mt-6">
              {SOCIAL_MEDIA.map(({ icon, link }, key) => (
                <a key={key} href={link} target="_blank" rel="noreferrer">
                  <i
                    className={`${icon} font-xl align-center mr-2 inline-block items-center justify-center rounded-full border-[1px] w-12 h-12 p-3 border-blue-gray-50 text-center text-primary outline-none focus:outline-none`}
                  />
                </a>
              ))}
            </div>
