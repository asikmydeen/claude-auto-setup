      ...
      <div className="relative mx-auto flex items-center text-blue-gray-900">
        ...
        <div className="hidden lg:flex ml-auto">
          ...
          <a href="https://discord.com/invite/WCvQWMwT" target="_blank">
            <Button size="sm" color="gray" variant="text">
          ...
          <a href="/astro-launch-ui-pro#examplePages">
            <Button className="mr-4" size="sm" variant="outlined" color="gray">Get started</Button>
          </a>
          <a href="https://github.com/creativetimofficial/astro-launch-ui" target="_blank">
            <Button size="sm" color="gray">Free download</Button>
          </a>
        </div>
        <IconButton
          size="sm"
