  ...
  <Card noBody>
    <div class="card-header border-0">
      <div class="row">
        ...
        <div class="col-6 text-right">
          <BaseButton type="primary" className="el-tooltip" icon size="sm">
    ...
    <div class="row w-100 mx-0">
      <table
        ...
        class="table-responsive table-flush table-striped align-items-center
        w-100 border-bottom-0" style="width:100%;">
        <thead class="border-top thead pagevisitsthead">
          <tr
            class="thead-light">
            <th
          ...
          {#each users as user, i}
            <tr
              ...
              <td
                ...
                rowspan="1"
                colspan="1"
                style="min-width: 140px; width: 170px; width: 10%">
                {user.createdAt}
              </td>
              <td
                class="thPadding"
