  ...
  head: [
     ['meta', {
      ...
      ['meta', {
        itemprop: "image",
        content:
          "https://s3.amazonaws.com/creativetim_bucket/products/732/original/opt_adp_nuxt_laravel_thumbnail.jpg",
      }],
      ['meta', {
        name: "twitter:card",
        content: "product",
      ...
      ['meta', {
        property: "og:url",
        content:
          "https://www.creative-tim.com/live/nuxt-argon-dashboard-pro-laravel-bs4",
      }],
      ['meta', {
        property: "og:image",
        content:
