  ...
  >
    ...
    <ul class="navbar-nav flex-row mr-auto ml-4 d-none d-md-flex">
      ...
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://nuxt-argon-dashboard-pro-laravel-bs4.creative-tim.com"
          target="_blank"
          >Live Preview</a
        >
      </li>
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://github.com/creativetimofficial/ct-nuxt-argon-dashboard-pro-laravel-bs4/issues"
          target="_blank"
          >Support</a
        >
      </li>
      <li class="nav-item">
        <a
          class="nav-link"
          href="https://github.com/creativetimofficial/ct-nuxt-argon-dashboard-pro-laravel-bs4"
          target="_blank"
          >Help with a star</a
        >
      </li>
