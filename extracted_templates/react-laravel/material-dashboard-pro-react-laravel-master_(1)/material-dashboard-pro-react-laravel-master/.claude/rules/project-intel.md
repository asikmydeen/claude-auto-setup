# Project Intelligence: material-dashboard-pro-react-laravel-master

## Overview
- **Project**: material-dashboard-pro-react-laravel-master
- **Type**: React + Laravel Fullstack Dashboard
- **Frontend**: React
- **Backend**: Laravel API
- **Laravel**: ^11.0

## Tech Stack
- **Frontend**: React (SPA in root)
...
## Key Dependencies
- **Frontend**: React, Axios, Vue Router/React Router
