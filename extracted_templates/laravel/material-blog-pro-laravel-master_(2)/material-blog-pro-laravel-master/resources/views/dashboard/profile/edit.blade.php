                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('Slug') }}"
                                                value="{{ old('slug', auth()->user()->slug) }}" required="true"
                                                aria-required="true" />
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('about') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('about') ? ' is-invalid' : '' }}"
                                                name="about" id="input-about" type="text"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('youtube') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('youtube') ? ' is-invalid' : '' }}"
                                                name="youtube" id="input-youtube" type="text"
                                ...
                                <button type="submit"
                                    class="btn btn-rose pull-right">{{ __('Update Profile') }}</button>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
                                ...
                                <button type="submit"
                                    class="btn btn-rose pull-right">{{ __('Change password') }}</button>
                                <div class="clearfix"></div>
                            </form>
                        </div>
                    </div>
