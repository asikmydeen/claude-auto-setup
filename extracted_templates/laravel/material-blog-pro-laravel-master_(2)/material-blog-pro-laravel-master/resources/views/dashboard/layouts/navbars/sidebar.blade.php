            ...
            <ul class="nav">
                <li class="dropdown nav-item">
                  <a href="/material/material-dashboard-pro/examples/dashboard.html" class="nav-link" target="_blank">
                    <i class="material-icons d-none d-lg-inline-block d-xl-inline-block">dashboard</i>{{ __('Dashboard') }}
                  </a>
                </li>
                ...
                <hr class="bg-white">
                <li class="nav-item{{ $activePage == 'widgets' ? ' active' : '' }} ">
                  <a class="nav-link" href="https://material-dashboard-pro-laravel.creative-tim.com/docs/getting-started/laravel-setup.html">
                ...
                <li class="nav-item ">
                  <a href="https://www.creative-tim.com/product/material-blog-pro-laravel" target="_blank" class="nav-link" style="background-color:#e91e63;">
