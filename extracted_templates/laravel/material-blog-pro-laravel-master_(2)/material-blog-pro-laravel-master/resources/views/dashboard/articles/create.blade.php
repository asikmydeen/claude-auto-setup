...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" action="{{ route('article.store') }}" autocomplete="off"
                        class="form-horizontal article-form">
                        @csrf
                        @method('post')
                        <div class="card ">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('excerpt') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('excerpt') ? ' is-invalid' : '' }}"
                                                ...
                                                placeholder="{{ __('Excerpt') }}" value="{{ old('excerpt') }}"
                                                required="true" aria-required="true" />
