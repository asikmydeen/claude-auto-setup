...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('articles')->insert([
            ...
            </p> </div> <div class="section col-md-12 ml-auto mr-auto"> <div class="row"> <div class="col-md-4"> <img class="img-raised rounded img-fluid " alt="Raised Image" src="/material/img/examples/img1-UPD.jpg"> </div> <div class="col-md-4"> <img class="img-raised rounded img-fluid" alt="Raised Image" src="/material/img/examples/img2-UPD.jpg"> </div> <div class="col-md-4"> <img class="img-raised rounded img-fluid" alt="Raised Image" src="/material/img/examples/img3-UPD.jpg"> </div> </div> </div> <div class="col-md-8 ml-auto mr-auto">
