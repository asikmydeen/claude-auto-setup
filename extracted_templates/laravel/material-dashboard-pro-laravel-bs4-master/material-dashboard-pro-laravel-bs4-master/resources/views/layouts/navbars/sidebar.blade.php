...
-->
  ...
  <div class="sidebar-wrapper">
    ...
    <ul class="nav">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link bg-danger" target="_blank" href="https://www.creative-tim.com/product/material-dashboard-pro-laravel-bs4">
          <i class="material-icons">shopping_cart</i>
            <p>Buy Now</p>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link bg-success" target="_blank" href="https://material-dashboard-pro-laravel-bs4.creative-tim.com/docs/getting-started/laravel-setup.html">
