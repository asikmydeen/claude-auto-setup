            ...
            <div class="w-full max-w-full px-3 mx-auto shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                <div
                    ...
                    <div class="flex-auto p-6 text-center">
                        <p class="mb-0 text-size-sm">You can login with 3 different user types:</p><br />
                        <p class="mb-0 text-size-sm">Email: <b>admin@softui.com</b> & Password: <b>secret</b></p>
                        <p class="mb-0 text-size-sm">Email: <b>creator@softui.com</b> & Password: <b>secret</b></p>
                        <p class="mb-0 text-size-sm">Email: <b>member@softui.com</b> & Password: <b>secret</b></p>
                    </div>
                    <div class="flex-auto p-6 text-center">
                        ...
                        <form wire:submit="login" role="form text-left">
                            ...
                            <div class="min-h-6 mb-0.5 block pl-12 text-left">
                                <input wire:model.live="remember_me" id="rememberMe"
