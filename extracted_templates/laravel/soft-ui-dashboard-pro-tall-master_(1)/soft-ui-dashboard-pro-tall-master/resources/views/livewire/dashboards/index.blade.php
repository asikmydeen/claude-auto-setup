                                            ...
                                            <div class="flex items-center px-2 py-1">
                                                ...
                                                <div class="ml-6">
                                                    <p
                                                        class="mb-0 font-semibold leading-tight text-size-xs dark:opacity-60">
                                                        Country:</p>
                                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Germany
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="flex-auto p-4">
                    <div class="py-4 pr-1 mb-4 bg-gradient-dark-gray dark:bg-gradient-neutral rounded-xl">
                        <div>
                            <canvas id="chart-bars" class="chart-canvas" height="170"></canvas>
                        </div>
                    </div>
                    <h6 class="mt-6 mb-0 ml-2 dark:text-white">Active Users</h6>
                    <p class="ml-2 leading-normal text-size-sm dark:opacity-60">(<span class="font-bold">+23%</span>)
                        than
                        last week</p>
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs dark:opacity-60">Users
                                    </p>
                                </div>
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs dark:opacity-60">Clicks
                                    </p>
                                </div>
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs dark:opacity-60">Sales
                                    </p>
                                </div>
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs dark:opacity-60">Items
                                    </p>
                                </div>
