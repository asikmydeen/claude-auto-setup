            ...
            <div class="container ">
                <div class="col-md-8 col-sm-9 ml-auto mr-auto mb-7">
                    ...
                    <div class="row d-flex justify-content-center">
                        <h3 class="text-lead text-white mt-5 mb-0"> <strong> {{ __('You can log in with 3 user types:') }}</strong></h3>
                        <ol class="text-lead text-light mt-3 mb-0"> 
                            <li>{{ __('Username') }} <b>admin@lightbp.com</b> {{ __('Password') }} <b>secret</b> </li>
                            <li>{{ __('Username') }} <b>creator@lightbp.com</b>  {{ __('Password') }} <b>secret</b> </li>
                            <li>{{ __('Username') }}<b> member@lightbp.com</b>  {{ __('Password') }} <b>secret</b> </li>
                        </ol>
                    </div>
                </div>
            </div>
