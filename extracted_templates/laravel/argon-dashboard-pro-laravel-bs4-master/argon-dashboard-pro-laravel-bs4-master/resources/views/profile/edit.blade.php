        ...
        <div class="row">
            <div class="col-xl-4 order-xl-2">
                <div class="card card-profile">
                    <img src="{{ asset('argon') }}/img/theme/img-1-1000x600.jpg" alt="Image placeholder"
                        class="card-img-top">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="{{ asset('argon') }}/img/theme/bootstrap.jpg">
                                        </a>
                                    </div>
                                    <div class="col">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="pt-2 form-group{{ $errors->has('photo') ? ' has-danger' : '' }}">
                                    <div class="form-group{{ $errors->has('photo') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label text-truncate" for="input-picture">{{ auth()->user()->profilePicture() ? str_replace('/profile_user/','',auth()->user()->profilePicture()): __('Select profile photo') }}</label>
                                        </div>
